...
Let's take a look at the imported libraries and see if anything looks shady.
```sh
g '^\s*import' | perl -lne 'print $1 if /import\s+(.*);/' | sort | uniq
...
android.support.v4.i.a
android.support.v4.i.ak
android.support.v4.i.al
android.support.v4.i.d
android.support.v4.i.n
android.support.v4.i.p
android.support.v4.i.q
android.support.v4.i.s
android.support.v4.i.v
android.support.v4.widget.k
android.support.v4.widget.m
android.support.v4.widget.n
android.support.v7.app.l
